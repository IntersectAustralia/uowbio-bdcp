                        ...
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <div class="columnLeft">
                            	<g:if test="${deviceManualFormInstanceList}">
                            		<g:link action="downloadFile" controller="studyDevice" mapping="studyDeviceManuals" params="[studyId: params.studyId, deviceId: params.deviceId, id: deviceManualFormInstance.id]">${fieldValue(bean: deviceManualFormInstance, field: "formName")}</g:link>
                            	</g:if>
                            </div>
