                ...
                <table>
                    ...
                    <g:each in="${deviceInstanceList}" status="i" var="deviceInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <g:link mapping="deviceFieldDetails" class="list" class="button" action="list" params="[deviceGroupId: params.deviceGroupId, deviceId: deviceInstance.id]">Metadata Template</g:link></td>
                        </tr>
                    </g:each>
                    </tbody>
                </table>
