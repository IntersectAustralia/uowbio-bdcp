...
<html>
    ...
    <div class="body">
            ...
            <g:form action="save" >
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="create" class="save right list" value="${message(code: 'default.button.create.label', default: 'Create')}" /></span>
                	<span class="button"><g:link elementId="cancel" class="list" controller="project" action="list">Cancel</g:link></span>
                </div>
            </g:form>
        </div>
    </body>
