...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form mapping="componentDetails" params="[studyId: params.studyId]" action="save" >
                <div class="dialog">
                    <table>
                        <tbody>
                ...
                <div class="buttons">
                	...
                	<span class="button"><g:link elementId="cancel" controller="study" action="show" id="${params.studyId}" params="[studyId: params.studyId]">Cancel</g:link></span>
                </div>
            </g:form>
        </div>
    </body>
