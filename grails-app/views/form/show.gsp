            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="form.participant.label" default="Participant" /></td>
                            
                            <td valign="top" class="value"><g:link controller="participant" action="show" id="${formInstance?.participant?.id}">${formInstance?.participant?.encodeAsHTML()}</g:link></td>
