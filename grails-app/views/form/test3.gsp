...
<html>
    <head>
        ...
        function addRow(tableID) {
			...
			var rawHTML = '<button id="create-user">Attach Form</button>';
            var cell2 = row.insertCell(1);
            var element2 = document.createElement("html");
            element2.innerHTML = rawHTML;
                ...
                <table id="dataTable">
                    ...
                    <g:each in="${formInstanceList}" status="i" var="formInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><button id="create-user">Attach Form</button></td>
