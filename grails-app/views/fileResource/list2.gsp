        ...
        <div class="body">
			...
			<h1>File Upload:</h1><br>
			 ...
			 <g:form method="post"  enctype="multipart/form-data">
	                <div class="dialog">
	                    <table>
	                        ...
	                        <tr class="prop">
	                            ...
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                    <label for="fileUpload">Form:</label>
	                                </td>
	                ...
	                <g:hiddenField name="fileName" value="${fileResourceInstance.decodeURL()}" />
	                <div class="buttons">
                ...
                <table>
                    ...
                    <g:each in="${fileResourceInstanceList}" status="i" var="fileResourceInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td> <input type="text" value="/forms/${fileResourceInstance.decodeURL()}"></input></td>
                            <td><a href="${createLinkTo( dir:'uploads/forms' , file: fileResourceInstance.decodeURL(), absolute:true )}" target="_new">view</a></td>
