...
/* end css tabs */
	...
	<ul id="tabnav">
		...
		<li class="tab4"><a href="${createLink(mapping: 'fileDetails', controller:'file', action:'list', params:['studyId': studyInstance.id])}" id="tabs-files" name="tabs-files"><span>Files</span></a></li>
	</ul>
