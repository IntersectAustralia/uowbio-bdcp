...
<html>
    ...
    <body>
           <div class="body" id="tab1"> 
            <h1><g:message code="default.showTitle.label" args="[studyInstance.studyTitle]" /><g:if test="${canPublish}"><button id="publishButton" class="buttons"><g:message code="study.publish.button" /></button></g:if></h1>
