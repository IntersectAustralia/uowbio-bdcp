...
class SecUserSecRole implements Serializable {
	...
	static SecUserSecRole create(UserStore secUser, SecRole secRole, boolean flush = false) {
		new SecUserSecRole(secUser: secUser, secRole: secRole).save(flush: flush, insert: true)
	}

	static boolean remove(UserStore secUser, SecRole secRole, boolean flush = false) {
		SecUserSecRole instance = SecUserSecRole.findBySecUserAndSecRole(secUser, secRole)
		instance ? instance.delete(flush: flush) : false
	}

	static void removeAll(UserStore secUser) {
