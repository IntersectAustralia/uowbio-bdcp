Feature: Add Device Manual Form
 ...
 Scenario: Create Device
    ...
    Then I should see "Device Manual Device1"
    Then I should see "Forms"
    Then I should see "Add Forms"
    ...
    Then I press "upload"
    Then I should see "2 Device manual forms uploaded"
    Then I press "Logout"
    ...
    Then I press "upload"
    Then I should see "1 Device manual form uploaded"
    Then I press "Logout"
