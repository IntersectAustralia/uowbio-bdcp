...
Before() {
  ...
  sql.execute("INSERT INTO user_store (id,version, username, deactivated, authority, nla_identifier, date_created, last_updated) VALUES ('-1','0','dpollum', 'false', 'ROLE_LAB_MANAGER', 'http://ands.org.au/1234', now(), now());")
  sql.execute("INSERT INTO user_store (id,version, username, deactivated, authority, nla_identifier, date_created, last_updated) VALUES ('-2','0','chrisk', 'false', 'ROLE_RESEARCHER', null, now(), now());")
